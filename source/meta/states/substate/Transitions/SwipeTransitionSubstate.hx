...
class SwipeTransitionSubstate extends TransitionSubstate
{
  ...
  override public function start(status: TransitionStatus){
    ...
    gradientFill = new FlxSprite().makeGraphic(1,1,FlxColor.BLACK);
    gradientFill.setGraphicSize(width,height);
    gradientFill.updateHitbox();
